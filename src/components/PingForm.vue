<template>
    ...
    <n-select id='selector' v-model:value="chosenvalue" multiple filterable placeholder="搜索Agent..." :options='opt' clearable/>
    <n-button text type='info' id="inputurl">目标参数</n-button>
    <n-input id='to-ping' v-model:value="to_ping" type="text" placeholder="在这里输入你要Ping的地址"/>
...
<script lang='ts'>
import {NSelect,NButton,NInput,NDataTable} from 'naive-ui'
